...
function AddProgramC() {
  const [showForm] = useState(true); // Set showForm to true by default
                  ...
                  <div>
                    <form onSubmit={addorEditTodo}>
                      <div className="row bg-gradient-light rounded border border-light shadow">
                        ...
                        <div className="col-sm-9 mt-4">
                          <select
                            value={selectedCoQuanChuTri}
                            onChange={handleCoQuanChuTriChange}
                            className="custom-select option-select"
                          >
                        ...
                        >
                          ...
                          <Tab
                            eventKey="leadership"
                            title="Ban chủ nhiệm chương trình"
                          >
                            <div className="row bg-gradient-light rounded m-5">
                              <div className="col-sm-3 mt-2">
                                <div className="input-group">
                              ...
                              <div className="col-sm-9 mt-2">
                                <select
                                  ...
                                  onChange={handleChuNhiemChange}
                                  className="custom-select option-select"
                                >
                                  {chuongTrinhOptions?.map((option) => (
                                    <option
                                      key={option.id}
                                      value={option.president}
                                    >
                                      {option.president}
                                    </option>
                                  ))}
                              ...
                              <div className="col-sm-9 mt-4">
                                <select
                                  value={selectedPhoChuNhiem}
                                  onChange={handlePhoChuNhiemChange}
                                  className="custom-select option-select"
                                >
                                  {chuongTrinhOptions?.map((option) => (
                                    <option
                                      key={option.id}
                                      value={option.vicePresident}
                                    >
                              ...
                              <div className="col-sm-3 mt-4">
                                <div className="input-group">
                                  <label
                                    ...
                                    for="reportType"
                                  >
                                    <b>Ủy viên, thư ký khoa học</b>
                                  </label>
                                </div>
                              </div>
                              <div className="col-sm-9 mt-4">
                                <select
                                  value={selectedThuKyKhoaHoc}
                                  onChange={handleThuKyKhoaHocChange}
                                  className="custom-select option-select"
                                >
                                  {chuongTrinhOptions?.map((option) => (
                                    <option
                                      key={option.id}
                                      value={option.admin_Secretary}
                                    >
                              ...
                              <div className="col-sm-9 mt-4">
                                <select
                                  value={selectedUyVien1}
                                  onChange={handleUyVien1Change}
                                  className="custom-select option-select"
                                >
                                  {chuongTrinhOptions?.map((option) => (
                                    <option
                                      key={option.id}
                                      value={option.member1}
                                    >
                                      {option.member1}
                                    </option>
                                  ))}
                              ...
                              <div className="col-sm-9 mt-4">
                                <select
                                  value={selectedUyVien2}
                                  onChange={handleUyVien2Change}
                                  className="custom-select option-select"
                                >
                                  {chuongTrinhOptions?.map((option) => (
                                    <option
                                      key={option.id}
                                      value={option.member2}
                                    >
                                      {option.member2}
                                    </option>
                                  ))}
                              ...
                              <div className="col-sm-9 mt-4">
                                <select
                                  value={selectedUyVien3}
                                  onChange={handleUyVien3Change}
                                  className="custom-select option-select"
                                >
                                  {chuongTrinhOptions?.map((option) => (
                                    <option
                                      key={option.id}
                                      value={option.member3}
                                    >
                                      {option.member3}
                                    </option>
                                  ))}
                              ...
                              <div className="col-sm-3 mt-4">
                                <div className="input-group">
                                  <label
                                    ...
                                    for="reportType"
                                  >
                                    <b>Thư ký hành chính</b>
                                  </label>
                                </div>
                              </div>
                              <div className="col-sm-9 mt-4">
                                <select
                                  value={selectedThuKyHanhChinh}
                                  onChange={handleThuKyHanhChinhChange}
                                  className="custom-select option-select"
                                >
                                  {chuongTrinhOptions?.map((option) => (
                                    <option
                                      key={option.id}
                                      value={option.member_Secretary}
                                    >
                        ...
                        <div className="col-sm-5 mt-3 mb-5">
                          <button
                            type="submit"
                            className="btn btn-info btn-sm mr-2 ml-5"
                          >
