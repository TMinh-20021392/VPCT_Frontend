                  ...
                  <div>
                    <form onSubmit={addorEditTodo}>
                      <div className="row bg-gradient-light rounded border border-light shadow">
                        ...
                        <div className="col-sm-4 mt-4 mr-5">
                          <input
                        ...
                        <div className="col-sm-2 mt-4">
                          <select
                            value={selectedLoaiNhiemVu}
                            onChange={handleLoaiNhiemVuChange}
                        ...
                        <div className="col-sm-3 mt-2">
                          <div className="input-group">
                            <label
                              ...
                              for="reportType"
                            >
                              <b>Trạng thái nhiệm vụ</b>
                            </label>
                          </div>
                        </div>
                        <div className="col-sm-9 mt-2">
                          <select
                            value={selectedStatusNhiemVu}
                            onChange={handleStatusNhiemVuChange}
                            className="custom-select option-select"
                          >
                        ...
                        <div className="col-sm-2 mt-4">
                          <select
                            value={selectedNghiemThuDate}
                            onChange={handleNghiemThuDateChange}
                            className="custom-select option-select"
                          >
                            {nhiemVuOptions?.map((option) => (
                              <option
                                key={option.id}
                                value={option.ngiemThu_Year}
                              >
                        ...
                        <div className="col-sm-2 mt-4">
                          <select
                            ...
                            onChange={handleThucHienChange}
                            className="custom-select option-select"
                          >
                            {nhiemVuOptions?.map((option) => (
                              <option
                                key={option.id}
                                value={option.fundingPlan_FirstYear}
                              >
                        ...
                        <div className="col-sm-2 mt-4">
                          <select
                            value={selectedNgoaiNS}
                            onChange={handleNgoaiNSChange}
                            className="custom-select option-select"
                          >
                            {nhiemVuOptions?.map((option) => (
                              <option
                                key={option.id}
                                value={option.fundingPlan_SecondYear}
                              >
                        ...
                        <div className="col-sm-2 mt-4">
                          <select
                            value={selectedNSNN}
                            onChange={handleNSNNChange}
                            className="custom-select option-select"
                          >
                            {nhiemVuOptions?.map((option) => (
                              <option
                                key={option.id}
                                value={option.fundingPlan_ThirdYear}
                              >
                        ...
                        <div className="col-sm-9 mt-4">
                          <select
                            value={selectedVPCTLeader}
                            onChange={handleVPCTLearderChange}
                            className="custom-select option-select"
                          >
                            {nhiemVuOptions?.map((option) => (
                              <option
                                key={option.id}
                                value={option.vpcT_Leader}
                              >
                                {option.vpcT_Leader}
                              </option>
                            ))}
                        ...
                        <div className="col-sm-9 mt-4">
                          ...
                          >
                            {nhiemVuOptions?.map((option) => (
                              <option
                                key={option.id}
                                value={option.planning_Specialist}
                              >
